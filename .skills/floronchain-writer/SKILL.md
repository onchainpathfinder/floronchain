...
Before writing anything, read `references/brand-context.md` for the full brand voice, audience segments, content formats, and distribution channel rules.
...
Read `references/brand-context.md` before writing any content. It contains the full brand voice guide, audience segments, content format details, distribution channel rules, and SEO requirements.
